            ...
            <div class="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-50">
                <div class="relative w-4/6">
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        <div class="bg-[url('/src/assets/CIT.png')] p-12 bg-center bg-no-repeat">
                            <div class="flex flex-col items-center justify-center px-20 py-10 rounded-t">
                                ...
                                <button type="button" class="text-white bg-primary hover:bg-secondary hover:text-primary font-medium rounded-lg text-sm px-5 py-2.5 my-10" onClick={openShowGrades}>SHOW GRADES</button>
                                ...
                                <button type="button" class="text-white bg-primary hover:bg-secondary hover:text-primary font-medium rounded-2xl text-sm px-20 py-2.5">SUBMIT</button>
